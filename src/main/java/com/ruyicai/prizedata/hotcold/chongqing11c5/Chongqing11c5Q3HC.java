...
public class Chongqing11c5Q3HC {

	public static final String KEY = "T01016HC_Q3";
	...
	public Chongqing11c5Q3HC refresh(List<PrizeInfo> prizeInfos,int countBatch) {
	...
	public static Chongqing11c5Q3HC fromJsonToChongqing11c5Q3HC(String json) {
		return new JSONDeserializer<Chongqing11c5Q3HC>().use(null,
				Chongqing11c5Q3HC.class).deserialize(json);

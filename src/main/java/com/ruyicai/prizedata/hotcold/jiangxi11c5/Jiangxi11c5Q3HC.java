...
public class Jiangxi11c5Q3HC {

	public static final String KEY = "T01010HC_Q3";
	...
	public Jiangxi11c5Q3HC refresh(List<PrizeInfo> prizeInfos,int countBatch) {
	...
	public static Jiangxi11c5Q3HC fromJsonToJiangxi11c5Q3HC(String json) {
		return new JSONDeserializer<Jiangxi11c5Q3HC>().use(null,
				Jiangxi11c5Q3HC.class).deserialize(json);

...
public class Shandong11c5Q3HC {

	public static final String KEY = "T01012HC_Q3";
	...
	public Shandong11c5Q3HC refresh(List<PrizeInfo> prizeInfos,int countBatch) {
	...
	public static Shandong11c5Q3HC fromJsonToShandong11c5Q3HC(String json) {
		return new JSONDeserializer<Shandong11c5Q3HC>().use(null,
				Shandong11c5Q3HC.class).deserialize(json);

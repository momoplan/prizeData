...
public class Shandong11c5RXHC {

	public static final String KEY = "T01012HC_RX";
	...
	public Shandong11c5RXHC refresh(List<PrizeInfo> prizeInfos, int countBatch) {
	...
	public static Shandong11c5RXHC fromJsonToShandong11c5RXHC(String json) {
		return new JSONDeserializer<Shandong11c5RXHC>().use(null,
				Shandong11c5RXHC.class).deserialize(json);

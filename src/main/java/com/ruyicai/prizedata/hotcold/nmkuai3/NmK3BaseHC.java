...
public class NmK3BaseHC {

	public static final String KEY = "F47107HC_BASE";
	 ...
	 * @return
	 */
	public NmK3BaseHC refresh(List<PrizeInfo> prizeInfos,int countBatch) {
	...
	public static NmK3BaseHC fromJsonToNmK3BaseHC(String json) {
		return new JSONDeserializer<NmK3BaseHC>().use(null,
				NmK3BaseHC.class).deserialize(json);

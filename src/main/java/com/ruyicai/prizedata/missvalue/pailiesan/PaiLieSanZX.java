 ...
 *
 */
public class PaiLieSanZX {

	public static final String KEY = "T01002MV_ZX";
	...
	public PaiLieSanZX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static PaiLieSanZX fromJsonToPaiLieSanZX(String json) {
		return new JSONDeserializer<PaiLieSanZX>().use(null, PaiLieSanZX.class)
				.deserialize(json);
	}

 ...
 *
 */
public class DuoLeCaiQ3ZH {

	public static final String KEY = "T01010MV_Q3ZH";
	...
	public DuoLeCaiQ3ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiQ3ZH fromJsonToDuoLeCaiQ3ZH(String json) {
		return new JSONDeserializer<DuoLeCaiQ3ZH>().use(null,
				DuoLeCaiQ3ZH.class).deserialize(json);
	}

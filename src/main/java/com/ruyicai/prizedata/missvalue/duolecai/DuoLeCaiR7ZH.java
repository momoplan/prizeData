 ...
 *
 */
public class DuoLeCaiR7ZH {

	public static final String KEY = "T01010MV_R7ZH";
	...
	public DuoLeCaiR7ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiR7ZH fromJsonToDuoLeCaiR7ZH(String json) {
		return new JSONDeserializer<DuoLeCaiR7ZH>().use(null,
				DuoLeCaiR7ZH.class).deserialize(json);
	}

 ...
 *
 */
public class DuoLeCaiQ2Z {

	public static final String KEY = "T01010MV_Q2Z";
	...
	public DuoLeCaiQ2Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiQ2Z fromJsonToDuoLeCaiQ2Z(String json) {
		return new JSONDeserializer<DuoLeCaiQ2Z>().use(null,
				DuoLeCaiQ2Z.class).deserialize(json);
	}

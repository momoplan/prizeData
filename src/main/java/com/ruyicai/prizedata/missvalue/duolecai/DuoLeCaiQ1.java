 ...
 *
 */
public class DuoLeCaiQ1 {

	public static final String KEY = "T01010MV_Q1";
	...
	public DuoLeCaiQ1 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiQ1 fromJsonToDuoLeCaiQ1(String json) {
		return new JSONDeserializer<DuoLeCaiQ1>().use(null,
				DuoLeCaiQ1.class).deserialize(json);
	}

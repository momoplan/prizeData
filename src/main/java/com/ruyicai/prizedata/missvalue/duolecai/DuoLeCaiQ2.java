 ...
 *
 */
public class DuoLeCaiQ2 {

	public static final String KEY = "T01010MV_Q2";
	...
	public DuoLeCaiQ2 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiQ2 fromJsonToDuoLeCaiQ2(String json) {
		return new JSONDeserializer<DuoLeCaiQ2>().use(null,
				DuoLeCaiQ2.class).deserialize(json);
	}

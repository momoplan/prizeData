 ...
 *
 */
public class DuoLeCaiR8ZH {

	public static final String KEY = "T01010MV_R8ZH";
	...
	public DuoLeCaiR8ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiR8ZH fromJsonToDuoLeCaiR8ZH(String json) {
		return new JSONDeserializer<DuoLeCaiR8ZH>().use(null,
				DuoLeCaiR8ZH.class).deserialize(json);
	}

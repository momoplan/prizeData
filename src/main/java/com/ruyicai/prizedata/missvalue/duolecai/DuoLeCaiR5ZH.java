 ...
 *
 */
public class DuoLeCaiR5ZH {

	public static final String KEY = "T01010MV_R5ZH";
	...
	public DuoLeCaiR5ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiR5ZH fromJsonToDuoLeCaiR5ZH(String json) {
		return new JSONDeserializer<DuoLeCaiR5ZH>().use(null,
				DuoLeCaiR5ZH.class).deserialize(json);
	}

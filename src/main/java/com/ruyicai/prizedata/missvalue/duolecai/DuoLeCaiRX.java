 ...
 *
 */
public class DuoLeCaiRX {

	public static final String KEY = "T01010MV_RX";
	...
	public DuoLeCaiRX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static DuoLeCaiRX fromJsonToDuoLeCaiRX(String json) {
		return new JSONDeserializer<DuoLeCaiRX>().use(null,
				DuoLeCaiRX.class).deserialize(json);
	}

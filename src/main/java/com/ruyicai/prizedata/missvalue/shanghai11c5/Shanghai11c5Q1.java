 ...
 *
 */
public class Shanghai11c5Q1 {

	public static final String KEY = "T01017MV_Q1";
	...
	public Shanghai11c5Q1 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5Q1 fromJsonToShanghai11c5Q1(String json) {
		return new JSONDeserializer<Shanghai11c5Q1>().use(null,
				Shanghai11c5Q1.class).deserialize(json);
	}

 ...
 *
 */
public class Shanghai11c5Q3 {

	public static final String KEY = "T01017MV_Q3";
	...
	public Shanghai11c5Q3 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5Q3 fromJsonToShanghai11c5Q3(String json) {
		return new JSONDeserializer<Shanghai11c5Q3>().use(null,
				Shanghai11c5Q3.class).deserialize(json);
	}

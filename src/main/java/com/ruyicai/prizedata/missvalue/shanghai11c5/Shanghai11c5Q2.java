 ...
 *
 */
public class Shanghai11c5Q2 {

	public static final String KEY = "T01017MV_Q2";
	...
	public Shanghai11c5Q2 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5Q2 fromJsonToShanghai11c5Q2(String json) {
		return new JSONDeserializer<Shanghai11c5Q2>().use(null,
				Shanghai11c5Q2.class).deserialize(json);
	}

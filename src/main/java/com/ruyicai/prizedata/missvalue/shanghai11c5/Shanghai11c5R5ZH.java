 ...
 *
 */
public class Shanghai11c5R5ZH {

	public static final String KEY = "T01017MV_R5ZH";
	...
	public Shanghai11c5R5ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5R5ZH fromJsonToShanghai11c5R5ZH(String json) {
		return new JSONDeserializer<Shanghai11c5R5ZH>().use(null,
				Shanghai11c5R5ZH.class).deserialize(json);
	}

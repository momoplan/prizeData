 ...
 *
 */
public class Shanghai11c5Q2Z {

	public static final String KEY = "T01017MV_Q2Z";
	...
	public Shanghai11c5Q2Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5Q2Z fromJsonToShanghai11c5Q2Z(String json) {
		return new JSONDeserializer<Shanghai11c5Q2Z>().use(null,
				Shanghai11c5Q2Z.class).deserialize(json);
	}

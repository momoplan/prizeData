 ...
 *
 */
public class Shanghai11c5R7ZH {

	public static final String KEY = "T01017MV_R7ZH";
	...
	public Shanghai11c5R7ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5R7ZH fromJsonToShanghai11c5R7ZH(String json) {
		return new JSONDeserializer<Shanghai11c5R7ZH>().use(null,
				Shanghai11c5R7ZH.class).deserialize(json);
	}

 ...
 *
 */
public class Shanghai11c5RX {

	public static final String KEY = "T01017MV_RX";
	...
	public Shanghai11c5RX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5RX fromJsonToChongqing11c5RX(String json) {
		return new JSONDeserializer<Shanghai11c5RX>().use(null,
				Shanghai11c5RX.class).deserialize(json);
	}

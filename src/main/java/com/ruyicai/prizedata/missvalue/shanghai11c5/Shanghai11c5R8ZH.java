 ...
 *
 */
public class Shanghai11c5R8ZH {

	public static final String KEY = "T01017MV_R8ZH";
	...
	public Shanghai11c5R8ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5R8ZH fromJsonToShanghai11c5R8ZH(String json) {
		return new JSONDeserializer<Shanghai11c5R8ZH>().use(null,
				Shanghai11c5R8ZH.class).deserialize(json);
	}

 ...
 *
 */
public class Shanghai11c5Q3Z {

	public static final String KEY = "T01017MV_Q3Z";
	...
	public Shanghai11c5Q3Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Shanghai11c5Q3Z fromJsonToShanghai11c5Q3Z(String json) {
		return new JSONDeserializer<Shanghai11c5Q3Z>().use(null,
				Shanghai11c5Q3Z.class).deserialize(json);
	}

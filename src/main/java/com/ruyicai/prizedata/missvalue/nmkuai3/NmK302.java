...
public class NmK302 {
	...
	public static final String KEY = "F47107MV_02";
	...
	public NmK302 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static NmK302 fromJsonToNmK302(String json) {
		return new JSONDeserializer<NmK302>().use(null, NmK302.class)
				.deserialize(json);
	}

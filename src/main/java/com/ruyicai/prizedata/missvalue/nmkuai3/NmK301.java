...
public class NmK301 {
	...
	public static final String KEY = "F47107MV_01";
	...
	public NmK301 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static NmK301 fromJsonToNmK301(String json) {
		return new JSONDeserializer<NmK301>().use(null, NmK301.class)
				.deserialize(json);
	}

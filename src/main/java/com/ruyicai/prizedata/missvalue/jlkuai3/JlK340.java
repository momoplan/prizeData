...
public class JlK340 {
	...
	public static final String KEY = "F47108MV_40";
	...
	public JlK340 refresh(PrizeInfoService prizeInfoService,int index) {
		int i = 0;
		int j = 0;
		boolean flag = true;
		while(flag){
	...
	public static JlK340 fromJsonToJlK340(String json) {
		return new JSONDeserializer<JlK340>().use(null, JlK340.class)
				.deserialize(json);
	}

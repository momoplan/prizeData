...
public class JlK392 {
	...
	public static final String KEY = "F47108MV_92";
	...
	public JlK392 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static JlK392 fromJsonToJlK392(String json) {
		return new JSONDeserializer<JlK392>().use(null,
				JlK392.class).deserialize(json);
	}

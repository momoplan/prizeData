...
public class JlK391 {
	...
	public static final String KEY = "F47108MV_91";
	...
	public void onPrize(PrizeInfo prizeInfo) {
		...
		if(JlK3Util.isErTong(win)) {
			result.put(JlK3Util.getErTongCode(win),0);
		}
	}
	
	
	public JlK391 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	private boolean refresh91(String win,Map<String, Object> mark,int i) {
		if(JlK3Util.isErTong(win)) {
			String ertongcode = JlK3Util.getErTongCode(win);
	...
	public static JlK391 fromJsonToJlK391(String json) {
		return new JSONDeserializer<JlK391>().use(null,
				JlK391.class).deserialize(json);
	}

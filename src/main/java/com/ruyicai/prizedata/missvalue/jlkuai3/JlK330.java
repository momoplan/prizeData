...
public class JlK330 {
	...
	public static final String KEY = "F47108MV_30";
	...
	public JlK330 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static JlK330 fromJsonToJlK330(String json) {
		return new JSONDeserializer<JlK330>().use(null, JlK330.class)
				.deserialize(json);
	}

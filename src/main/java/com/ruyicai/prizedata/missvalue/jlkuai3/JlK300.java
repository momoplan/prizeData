...
public class JlK300 {
	...
	public static final String KEY = "F47108MV_BASE";
	...
	public JlK300 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static JlK300 fromJsonToJlK300(String json) {
		return new JSONDeserializer<JlK300>().use(null, JlK300.class)
				.deserialize(json);
	}

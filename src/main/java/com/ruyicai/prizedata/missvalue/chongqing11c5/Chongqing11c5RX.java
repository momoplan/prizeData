 ...
 *
 */
public class Chongqing11c5RX {

	public static final String KEY = "T01016MV_RX";
	...
	public Chongqing11c5RX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5RX fromJsonToChongqing11c5RX(String json) {
		return new JSONDeserializer<Chongqing11c5RX>().use(null,
				Chongqing11c5RX.class).deserialize(json);
	}

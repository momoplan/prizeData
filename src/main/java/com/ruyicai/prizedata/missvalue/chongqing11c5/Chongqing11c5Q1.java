 ...
 *
 */
public class Chongqing11c5Q1 {

	public static final String KEY = "T01016MV_Q1";
	...
	public Chongqing11c5Q1 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5Q1 fromJsonToChongqing11c5Q1(String json) {
		return new JSONDeserializer<Chongqing11c5Q1>().use(null,
				Chongqing11c5Q1.class).deserialize(json);
	}

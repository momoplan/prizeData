 ...
 *
 */
public class Chongqing11c5R8ZH {

	public static final String KEY = "T01016MV_R8ZH";
	...
	public Chongqing11c5R8ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5R8ZH fromJsonToChongqing11c5R8ZH(String json) {
		return new JSONDeserializer<Chongqing11c5R8ZH>().use(null,
				Chongqing11c5R8ZH.class).deserialize(json);
	}

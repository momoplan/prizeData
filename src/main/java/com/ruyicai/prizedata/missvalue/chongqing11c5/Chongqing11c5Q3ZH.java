 ...
 *
 */
public class Chongqing11c5Q3ZH {

	public static final String KEY = "T01016MV_Q3ZH";
	...
	public Chongqing11c5Q3ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5Q3ZH fromJsonToChongqing11c5Q3ZH(String json) {
		return new JSONDeserializer<Chongqing11c5Q3ZH>().use(null,
				Chongqing11c5Q3ZH.class).deserialize(json);
	}

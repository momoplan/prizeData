 ...
 *
 */
public class Chongqing11c5Q3 {

	public static final String KEY = "T01016MV_Q3";
	...
	public Chongqing11c5Q3 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5Q3 fromJsonToChongqing11c5Q3(String json) {
		return new JSONDeserializer<Chongqing11c5Q3>().use(null,
				Chongqing11c5Q3.class).deserialize(json);
	}

 ...
 *
 */
public class Chongqing11c5Q2 {

	public static final String KEY = "T01016MV_Q2";
	...
	public Chongqing11c5Q2 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5Q2 fromJsonToChongqing11c5Q2(String json) {
		return new JSONDeserializer<Chongqing11c5Q2>().use(null,
				Chongqing11c5Q2.class).deserialize(json);
	}

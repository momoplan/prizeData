 ...
 *
 */
public class Chongqing11c5Q2Z {

	public static final String KEY = "T01016MV_Q2Z";
	...
	public Chongqing11c5Q2Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Chongqing11c5Q2Z fromJsonToChongqing11c5Q2Z(String json) {
		return new JSONDeserializer<Chongqing11c5Q2Z>().use(null,
				Chongqing11c5Q2Z.class).deserialize(json);
	}

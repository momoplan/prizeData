 ...
 * 
 */
public class CqHappytenR4ZH {

	public static final String KEY = "F47109MV_R4ZH";
	...
	public CqHappytenR4ZH refresh(PrizeInfoService prizeInfoService, int index) {
	...
	public static CqHappytenR4ZH fromJsonToCqHappytenR4ZH(String json) {
		return new JSONDeserializer<CqHappytenR4ZH>().use(null,
				CqHappytenR4ZH.class).deserialize(json);
	}

 ...
 * 
 */
public class CqHappytenR2ZH {

	public static final String KEY = "F47109MV_R2ZH";
	...
	public CqHappytenR2ZH refresh(PrizeInfoService prizeInfoService, int index) {
	...
	public static CqHappytenR2ZH fromJsonToCqHappytenR2ZH(String json) {
		return new JSONDeserializer<CqHappytenR2ZH>().use(null,
				CqHappytenR2ZH.class).deserialize(json);
	}

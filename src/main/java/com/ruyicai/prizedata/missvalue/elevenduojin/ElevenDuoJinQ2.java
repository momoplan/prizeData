 ...
 *
 */
public class ElevenDuoJinQ2 {

	public static final String KEY = "T01012MV_Q2";
	...
	public ElevenDuoJinQ2 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinQ2 fromJsonToElevenDuoJinQ2(String json) {
		return new JSONDeserializer<ElevenDuoJinQ2>().use(null,
				ElevenDuoJinQ2.class).deserialize(json);
	}

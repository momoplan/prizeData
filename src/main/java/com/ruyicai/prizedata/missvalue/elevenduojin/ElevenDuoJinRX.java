 ...
 *
 */
public class ElevenDuoJinRX {

	public static final String KEY = "T01012MV_RX";
	...
	public ElevenDuoJinRX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinRX fromJsonToElevenDuoJinRX(String json) {
		return new JSONDeserializer<ElevenDuoJinRX>().use(null,
				ElevenDuoJinRX.class).deserialize(json);
	}

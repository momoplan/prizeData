 ...
 *
 */
public class ElevenDuoJinQ3Z {

	public static final String KEY = "T01012MV_Q3Z";
	...
	public ElevenDuoJinQ3Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinQ3Z fromJsonToElevenDuoJinQ3Z(String json) {
		return new JSONDeserializer<ElevenDuoJinQ3Z>().use(null,
				ElevenDuoJinQ3Z.class).deserialize(json);
	}

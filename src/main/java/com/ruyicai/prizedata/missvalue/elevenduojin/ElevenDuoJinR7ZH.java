 ...
 *
 */
public class ElevenDuoJinR7ZH {

	public static final String KEY = "T01012MV_R7ZH";
	...
	public ElevenDuoJinR7ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinR7ZH fromJsonToElevenDuoJinR7ZH(String json) {
		return new JSONDeserializer<ElevenDuoJinR7ZH>().use(null,
				ElevenDuoJinR7ZH.class).deserialize(json);
	}

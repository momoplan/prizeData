 ...
 *
 */
public class ElevenDuoJinQ3ZH {

	public static final String KEY = "T01012MV_Q3ZH";
	...
	public ElevenDuoJinQ3ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinQ3ZH fromJsonToElevenDuoJinQ3ZH(String json) {
		return new JSONDeserializer<ElevenDuoJinQ3ZH>().use(null,
				ElevenDuoJinQ3ZH.class).deserialize(json);
	}

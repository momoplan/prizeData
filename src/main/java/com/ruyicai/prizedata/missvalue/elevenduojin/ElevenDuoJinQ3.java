 ...
 *
 */
public class ElevenDuoJinQ3 {

	public static final String KEY = "T01012MV_Q3";
	...
	public ElevenDuoJinQ3 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinQ3 fromJsonToElevenDuoJinQ3(String json) {
		return new JSONDeserializer<ElevenDuoJinQ3>().use(null,
				ElevenDuoJinQ3.class).deserialize(json);
	}

 ...
 *
 */
public class ElevenDuoJinR5ZH {

	public static final String KEY = "T01012MV_R5ZH";
	...
	public ElevenDuoJinR5ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static ElevenDuoJinR5ZH fromJsonToElevenDuoJinR5ZH(String json) {
		return new JSONDeserializer<ElevenDuoJinR5ZH>().use(null,
				ElevenDuoJinR5ZH.class).deserialize(json);
	}

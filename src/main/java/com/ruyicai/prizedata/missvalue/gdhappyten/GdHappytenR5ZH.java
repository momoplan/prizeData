 ...
 * 
 */
public class GdHappytenR5ZH {

	public static final String KEY = "T01015MV_R5ZH";
	...
	public GdHappytenR5ZH refresh(PrizeInfoService prizeInfoService, int index) {
	...
	public static GdHappytenR5ZH fromJsonToGdHappytenR5ZH(String json) {
		return new JSONDeserializer<GdHappytenR5ZH>().use(null,
				GdHappytenR5ZH.class).deserialize(json);
	}

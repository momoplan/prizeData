 ...
 * 
 */
public class GdHappytenRX {

	public static final String KEY = "T01015MV_RX";
	...
	public GdHappytenRX refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static GdHappytenRX fromJsonToGdHappytenRX(String json) {
		return new JSONDeserializer<GdHappytenRX>().use(null,
				GdHappytenRX.class).deserialize(json);
	}

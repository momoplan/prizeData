 ...
 *
 */
public class GdHappytenQ3 {

	public static final String KEY = "T01015MV_Q3";
	...
	public GdHappytenQ3 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static GdHappytenQ3 fromJsonToGdHappytenQ3(String json) {
		return new JSONDeserializer<GdHappytenQ3>().use(null,
				GdHappytenQ3.class).deserialize(json);
	}

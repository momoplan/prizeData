 ...
 * 
 */
public class GdHappytenR3ZH {

	public static final String KEY = "T01015MV_R3ZH";
	...
	public GdHappytenR3ZH refresh(PrizeInfoService prizeInfoService, int index) {
	...
	public static GdHappytenR3ZH fromJsonToGdHappytenR3ZH(String json) {
		return new JSONDeserializer<GdHappytenR3ZH>().use(null,
				GdHappytenR3ZH.class).deserialize(json);
	}

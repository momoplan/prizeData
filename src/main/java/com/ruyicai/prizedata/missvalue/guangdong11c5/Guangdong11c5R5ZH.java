 ...
 *
 */
public class Guangdong11c5R5ZH {

	public static final String KEY = "T01014MV_R5ZH";
	...
	public Guangdong11c5R5ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5R5ZH fromJsonToGuangdong11c5R5ZH(String json) {
		return new JSONDeserializer<Guangdong11c5R5ZH>().use(null,
				Guangdong11c5R5ZH.class).deserialize(json);
	}

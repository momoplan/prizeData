 ...
 *
 */
public class Guangdong11c5Q1 {

	public static final String KEY = "T01014MV_Q1";
	...
	public Guangdong11c5Q1 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5Q1 fromJsonToGuangdong11c5Q1(String json) {
		return new JSONDeserializer<Guangdong11c5Q1>().use(null,
				Guangdong11c5Q1.class).deserialize(json);
	}

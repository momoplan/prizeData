 ...
 *
 */
public class Guangdong11c5Q3 {

	public static final String KEY = "T01014MV_Q3";
	...
	public Guangdong11c5Q3 refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5Q3 fromJsonToGuangdong11c5Q3(String json) {
		return new JSONDeserializer<Guangdong11c5Q3>().use(null,
				Guangdong11c5Q3.class).deserialize(json);
	}

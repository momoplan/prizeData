 ...
 *
 */
public class Guangdong11c5R7ZH {

	public static final String KEY = "T01014MV_R7ZH";
	...
	public Guangdong11c5R7ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5R7ZH fromJsonToGuangdong11c5R7ZH(String json) {
		return new JSONDeserializer<Guangdong11c5R7ZH>().use(null,
				Guangdong11c5R7ZH.class).deserialize(json);
	}

 ...
 *
 */
public class Guangdong11c5Q3ZH {

	public static final String KEY = "T01014MV_Q3ZH";
	...
	public Guangdong11c5Q3ZH refresh(PrizeInfoService prizeInfoService,int index) {
			...
			for(int j=1;j<=11;j++) {
				for(int k=1;k<=11;k++) {
					if(isSame(i,j,k)) {
						...
						System.out.println(getKey(i,j,k));
					}
				}
			}
		}
	...
	public static Guangdong11c5Q3ZH fromJsonToGuangdong11c5Q3ZH(String json) {
		return new JSONDeserializer<Guangdong11c5Q3ZH>().use(null,
				Guangdong11c5Q3ZH.class).deserialize(json);
	}

 ...
 *
 */
public class Guangdong11c5Q2Z {

	public static final String KEY = "T01014MV_Q2Z";
	...
	public Guangdong11c5Q2Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5Q2Z fromJsonToGuangdong11c5Q2Z(String json) {
		return new JSONDeserializer<Guangdong11c5Q2Z>().use(null,
				Guangdong11c5Q2Z.class).deserialize(json);
	}

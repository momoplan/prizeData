 ...
 *
 */
public class Guangdong11c5R8ZH {

	public static final String KEY = "T01014MV_R8ZH";
	...
	public Guangdong11c5R8ZH refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5R8ZH fromJsonToGuangdong11c5R8ZH(String json) {
		return new JSONDeserializer<Guangdong11c5R8ZH>().use(null,
				Guangdong11c5R8ZH.class).deserialize(json);
	}

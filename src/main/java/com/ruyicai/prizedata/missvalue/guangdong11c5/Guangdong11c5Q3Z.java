 ...
 *
 */
public class Guangdong11c5Q3Z {

	public static final String KEY = "T01014MV_Q3Z";
	...
	public Guangdong11c5Q3Z refresh(PrizeInfoService prizeInfoService,int index) {
	...
	public static Guangdong11c5Q3Z fromJsonToGuangdong11c5Q3Z(String json) {
		return new JSONDeserializer<Guangdong11c5Q3Z>().use(null,
				Guangdong11c5Q3Z.class).deserialize(json);
	}
